...
@Component({
  selector: 'app-mtusbs-list',
  templateUrl: './mtusbs-list.component.html',
  styleUrls: ['./mtusbs-list.component.css']
})
export class MtusbsListComponent implements OnInit {
  UserName: any;
...
constructor(public api: ApiService, private router: Router) {
  ...
  //========================================================= bring all data ====================================================================================
 async bring_servers(){
  let tmp = await this.api.write_to_log("Mtusbs component loaded")// write string to log
  ...
  tmp = await this.api.write_to_log("retrived all servers from db")// write string to log
  ...
  tmp = await this.api.write_to_log("Retrived mtusbs list")// write string to log
